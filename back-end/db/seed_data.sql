--businesses
INSERT INTO businesses (name, name_slug, phone, address_1, address_2, description, thumb_img, keywords, active, status)
VALUES 
  ( 'Tacos Al Suadero', 'tacos-al-suadero', '(718) 506-1025', '8812 Roosevelt Ave', NULL, 'The interior of the place is as festive as other similarly themed restaurants. There are ornaments, ribbons, and all sorts of colorful articles from wall to wall and across the ceiling. Seating is just enough for a few groups, but even then there isn''t much room for dining here. As Spanish songs play in the background, its easy to feel like one is no longer in Queens.', 'https://s3-media3.fl.yelpcdn.com/bphoto/VWIaD4Y2_-2xnKFZbisH7A/o.jpg', 'tacos mexican food tostadas quesadilla', TRUE, 'OPERATING'),
  ( 'King River', 'king-river', '(718) 506-1025', '8812 Roosevelt Ave', NULL, 'The interior of the place is as festive as other similarly themed restaurants. There are ornaments, ribbons, and all sorts of colorful articles from wall to wall and across the ceiling. Seating is just enough for a few groups, but even then there isnt much room for dining here. As Spanish songs play in the background, its easy to feel like one is no longer in Queens.', 'https://geo0.ggpht.com/cbk?photoid=3cfe_dFaDw0AAAQfCU_UkA&output=photo', 'chinese chicken ramen soup', FALSE, 'PENDING APPROVAL' ),
  ( 'Sammy''s Halal Food', 'sammys-halal-food', '(718) 775-8369', '73rd St And, Broadway, NY 11372', 'STREET', 'Sammy''s halal is hands down probably the best lamb over rice you can find out there now. ', 'https://s3-media0.fl.yelpcdn.com/bphoto/O-aMOt_uboQBWaVj3lwUdA/o.jpg', 'halal chicken over rice falafel gyro lamb', TRUE, 'OPERATING' ) 
  ;
